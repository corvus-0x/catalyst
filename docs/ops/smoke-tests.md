...
- [ ] Search "Smith" with county "Darke" → either parcel results OR a clear "ODNR API unavailable" error
...
- [ ] Pick a county (e.g. "Darke"), enter a name → "Open Recorder Portal" link is generated
