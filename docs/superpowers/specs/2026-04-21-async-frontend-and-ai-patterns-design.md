...
investigation forward: "Sarah Example on this 990 is the same person as K. S.
...
User clicks "Search IRS"
        ↓
useAsyncJob.run({name: "Bright Future Foundation"})
        ↓
  ...
  "patterns": [
    {
      ...
      "description": "Sarah Example on the 2021 990 appears to match K. S. Example on the 2019 deed for parcel 12345.",
