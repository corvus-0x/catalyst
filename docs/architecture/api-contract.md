  ...
  "results": [
    {
      ...
      "narrative": "Karen Example purchased the property from Example Construction LLC...",
      "severity": "CRITICAL",
      "status": "CONFIRMED",
  ...
  "related_findings": [
    {
      ...
      "severity": "CRITICAL",
      "status": "CONFIRMED",
      "context_note": "Karen Example is the buyer"
    }
  ],
  "organization_roles": [
    {
  ...
  "results": [
    {
      ...
      "incoming_normalized": "karen example",
      "existing_entity_id": "uuid",
      "existing_raw": "Karen Example",
      "similarity": 0.9143,
      "status": "PENDING",
      "detected_at": "ISO8601",
      "resolved_at": null,
