...
Investigative context:
    ...
    searching "EXAMPLE" across all 88 counties in one query reveals whether
...
ODNR_PARCEL_QUERY_URL_FALLBACK = "https://services1.arcgis.com/3mEFe0kHlJBSNSuE/arcgis/rest/services/Ohio_Parcels/FeatureServer/0/query"
...
_AUDITOR_REGISTRY: dict[OhioCounty, AuditorInfo] = {
    ...
    OhioCounty.MERCER: AuditorInfo(
        ...
        phone="419-586-6402",
        address="105 N Main St, Example City, OH 45822",
    ),
...
def search_parcels_by_owner(
    ...
    mode: searching "EXAMPLE" across all counties reveals statewide patterns.
    ...
    Example:
        # Cross-county search — finds every parcel owned by "EXAMPLE" in Ohio
        result = search_parcels_by_owner("EXAMPLE")
...
_AUDITOR_DOMAIN_SUFFIXES = (
    ...
    ".devnetwedge.com",
    ".arcgis.com",
    ".schneidercorp.com",  # Beacon platform — hosts parcel portals for many OH counties
)
