...
#   - Charity gives lot to Keller (Example Lender officer's family)
# ---------------------------------------------------------------------------
...
# persons). But our database has Relationship records proving Sarah Example
...
# Limit raised from 60→120: real Part IV lines include the full question text
# before the answer, which routinely exceeds 60 characters.
_LINE_28_NO_PATTERNS = [
    re.compile(r"28[abc][^\n]{0,120}\bno\b", re.IGNORECASE),
