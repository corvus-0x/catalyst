...
def _sample_feature(
    ...
    # Domain must be SEC-037-allowlisted (_AUDITOR_DOMAIN_SUFFIXES) or
    # _validate_auditor_url() nulls it; devnetwedge.com is a real OH auditor portal vendor.
    aud_link: str = "https://senecaoh.devnetwedge.com/parcel/22-001234",
) -> dict:
