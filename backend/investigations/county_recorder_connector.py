...
Usage:
    ...
    url_info = get_search_url(OhioCounty.SENECA, grantor_grantee="EXAMPLE")
    print(url_info.url)
...
_REGISTRY: dict[OhioCounty, CountyInfo] = {
    ...
    OhioCounty.DARKE: CountyInfo(
        ...
        search_url_template=None,
        portal_notes="Darke County migrated to Fidlar AVA. Free public index search. No login required. Verified working. Key county for Example Township investigation.",
        phone="937-547-7360",
    ...
    OhioCounty.MERCER: CountyInfo(
        ...
        portal_notes=(
            ...
            "Free public index search — no login required. "
            "KEY COUNTY: Central to the Example Township investigation — grantor/grantee "
        ...
        phone="419-586-6402",
        address="101 N Main St, Example City, OH 45822",
        records_from=1987,
    ),
    ...
    OhioCounty.SENECA: CountyInfo(
        ...
        portal_notes=(
            ...
            "name first (e.g., 'EXAMPLE DAVID'). For recent amendments and anything after "
...
def get_search_url(
    ...
    Example:
        ...
        # Opens browser, logs in as guest, searches for EXAMPLE
    """
    info = get_county_info(county)
